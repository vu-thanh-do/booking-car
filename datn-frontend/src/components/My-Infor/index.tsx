  ...
  useEffect(() => {
    const handleFetchUser = async () => {
      try {
        ...
        setCheckUser(data.user.loyalCustomers == true ? 'Thân thiết' : 'Mặc định')
        console.log(data, 'cc')
      } catch (error) {
            ...
            <form action='' onSubmit={handleSubmit(onInfor)} className='h-full'>
              {isUpdateInfor || isUpdateAvatar ? (
                ...
                <div className='flex flex-wrap'>
                  ...
                  <div className='item-profile w-[50%] my-3'>
                    <label className='block py-2 text-[#959393]'>Địa chỉ</label>
                  ...
                  {/* <div className='item-profile w-[50%] my-3'>
                    <label className='block py-2 text-[#959393]'> Loại Tài khoản</label>
                    <input
                      className='w-full g-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none'
                      type='text'
                      // name='loyalCustomers'
