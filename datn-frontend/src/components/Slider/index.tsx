            ...
            <div key={uuidv4()} className='item relative'>
              ...
              <div className='slide-content center-slider text-center'>
                <div className='flex items-center justify-center'>
                  <Link
                    to='/products'
                    className=' hover:bg-[#d3b673] w-[196px] h-full  max-w-[206px] text-[16px] uppercase py-[10px] text-white border border-white px-[15px] inline-block font-semibold'
                  >
                  {/* {t('product.booknow')} */} Đặt xe ngay
                  </Link>
                </div>
                <div className={`${styles.cursor} hidden md:block`}></div>
                <div className='text-sm text-white hidden md:block'>{t('product.scrd')}</div>
              </div>
            </div>
          ))
        ) : (
