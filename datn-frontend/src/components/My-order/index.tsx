...
const MyOrder = () => {
  ...
  const listReason: string[] = [
    'Không muốn book chuyến xe này nữa.',
    'chuyến xe không đúng mô tả trên trang web.',
    'Đã tìm thấy một chuyến xe tốt hơn ở nơi khác.',
    'chuyến xe không còn cần thiết.',
    'Thay đổi ý định book chuyến xe.',
    'Gặp vấn đề tài chính không thể book chuyến xe.',
    'Đặt chuyến xe nhầm.',
    'Thời gian giao chuyến xe quá chậm.'
  ]
  ...
  return (
    <>
      ...
      <div className='layout-container w-full'>
        <h2 className='title text-[#333] text-lg font-medium mb-5'>Lịch sử đặt xe</h2>
