    ...
    >
      <div className='container my-0 mx-auto flex items-center justify-between '>
        <div className='left flex items-center gap-5 '>
          ...
          {/* <button
            className='py-2 px-3 text-left bg-yellow-200  rounded-md shadow-xl'
            onClick={() => changeLanguage('vi')}
          >
            Tiếng Việt
          </button>
          <button
            className='mt-2 py-2 px-3 text-left bg-green-400 rounded-md shadow-xl'
        ...
        <div className='right '>
          {user?.avatar ? (
            <Link
              to='/account-layout'
              className='hidden w-10 h-10 rounded-[50%] md:flex items-center justify-center bg-[#d3b673] text-white'
            >
